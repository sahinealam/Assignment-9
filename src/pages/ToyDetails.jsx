        ...
        <section className=' w-11/12 mx-auto my-10 space-y-5'>
            <div>
                        ...
                        <div className="ml-[50px]">
                            <div className="md:ml-10 ">
                                ...
                                <p className="mt-2 text-xl">
                                    Price: <span className="text-[#632EE3] text-2xl">{toy.price}</span>
                                </p>
                            ...
                            <div className=" ml-10 mt-8">
                                ...
                                <div className="mt-5 md:mt-0">
                                    ...
                                    <p>Average Ratings</p>
                                    <h1 className="font-bold text-5xl">{toy.rating}</h1>
                                </div>
                            ...
                            <div className=" ml-10 mt-8">
                                ...
                                <div className="mt-5 md:mt-0">
                                    ...
                                    <p>Available Stock</p>
                                    <h1 className="font-bold text-5xl">{toy.availableStock}</h1>
                                </div>
                ...
                <div>
                    ...
                    <p className='text-gray-400 mt-5'>{toy.description}</p>
                </div>
            </div>
